...
class ProverbHelper
{
    ...
    public function getPublishedProverb()
    {
        return $this->getProverb()->setPublished(new \DateTime('2017-01-24 20:00:00'));
    }

    public function getNonPublishedProverb()
    {
        return $this->getProverb()->setPublished(null);
    }
